...
import {cityInputMsg} from "./update"

const {pre, div, h1, form, td, tr, tbody, th, table, i, label, input} = hh(h)
...
function fieldSet(_dispatch, _value, _inputMsg) {
  return div(
    {className: "mw-50 ma1"}
    , input({
...
function view(_dispatch, _model) {
  return div(
    ...
    , [
      ...
      , fieldSet(_dispatch, _model.city, cityInputMsg)
